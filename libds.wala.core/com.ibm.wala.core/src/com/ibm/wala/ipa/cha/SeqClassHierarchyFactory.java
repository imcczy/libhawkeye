...
//added by imcczy
  public static ClassHierarchy make(AnalysisScope scope, IClassLoader iClassLoader) throws ClassHierarchyException {
      if (scope == null) {
          throw new IllegalArgumentException("null scope");
      }
      return make(scope, new ClassLoaderFactoryImpl(scope.getExclusions()),iClassLoader);
  }

  //added by imcczy
  public static ClassHierarchy make(AnalysisScope scope, IClassLoader iClassLoader,Map<TypeReference, Node> map) throws ClassHierarchyException {
      if (scope == null) {
          throw new IllegalArgumentException("null scope");
      }
      return make(scope, new ClassLoaderFactoryImpl(scope.getExclusions()),iClassLoader);
  ...
  public static ClassHierarchy make(AnalysisScope scope, ClassLoaderFactory factory) throws ClassHierarchyException {
    ...
    return new ClassHierarchy(scope, factory, null, HashMapFactory.<TypeReference, Node>make(),null);
  }

//added by imcczy
  public static ClassHierarchy make(AnalysisScope scope, ClassLoaderFactory factory, IClassLoader iClassLoader,Map<TypeReference, ClassHierarchy.Node> map) throws ClassHierarchyException {
      if (scope == null) {
          throw new IllegalArgumentException("null scope");
      }
      if (factory == null) {
      ...
      return new ClassHierarchy(scope, factory, null, map,iClassLoader);
  }
  public static ClassHierarchy make(AnalysisScope scope, ClassLoaderFactory factory, IClassLoader iClassLoader) throws ClassHierarchyException {
      if (scope == null) {
          throw new IllegalArgumentException("null scope");
      }
      if (factory == null) {
      ...
      return new ClassHierarchy(scope, factory, null, HashMapFactory.<TypeReference, Node>make(),iClassLoader);
  }
  ...
  public static ClassHierarchy make(AnalysisScope scope, ClassLoaderFactory factory, IProgressMonitor monitor)
      throws ClassHierarchyException {
    return new ClassHierarchy(scope, factory, monitor, HashMapFactory.<TypeReference, Node>make(),null);
  }

  public static ClassHierarchy make(AnalysisScope scope, ClassLoaderFactory factory, Set<Language> languages)
      throws ClassHierarchyException {
    return new ClassHierarchy(scope, factory, languages, null, HashMapFactory.<TypeReference, Node>make(),null);
  }
